...
import { getCurrentMode, initModeButtons } from './modes.js';
...
function setupEventListeners() {
    ...
    elements.chatForm.addEventListener('submit', async function (e) {
        ...
        if (message && !isWaitingForResponse) {
            ...
            const success = await sendMessage(message, getCurrentConversationId(), getCurrentMode(), isWaitingForResponse);
            isWaitingForResponse = !success;
        }
    });
